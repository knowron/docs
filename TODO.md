...
- [x] **TODO-17** Create page for **Single Sign-On (SSO)** (Add-on) — how to configure, supported identity providers | Priority: High | Affects: en, de | File(s): `docs/Admin Documentation/sso.md` | Draft: `_context/_drafts/sso.md` | Completed: 2026-03-19
