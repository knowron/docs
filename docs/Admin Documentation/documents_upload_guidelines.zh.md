...
我们一直在努力寻找更好的方法来阅读和理解您的文档和数据。不要犹豫 [联系我们的销售和支持 team](mailto:ask@knowron.com），以探索诸如**光学字符识别 （OCR）**、**表格解析** 和其他类似改进的可能性。


## KNOWRON 如何利用 NLP 分析文档
...
* 请注意，OCR 功能是我们高级升级的一部分。如果您有兴趣体验 OCR 的好处，请随时 [联系我们的支持 team](mailto:ask@knowron.com]。他们将非常乐意为您提供详细信息并帮助您启用此功能。
...
在之前与我们的支持团队达成协议后，我们目前支持非 pdf 文档。再次，请联系 [我们的销售 team](mailto:ask@knowron.com） 了解更多信息。