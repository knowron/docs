...
!!!info “默认情况下不启用此功能”
如果您想为您的组织试用产品访问组，请联系<arturo@knowron.com>。
...
想象一下一家公司，**3D Printers GmbH**。他们为工业市场生产和销售3D打印机。他们正在使用 KNOWRON 来满足其广泛的文档和信息交付需求。3D Printers GmbH 根据其所在地区有两个部门：**EMEA** 和 **Americas**。这两个部门都隶属于总部位于慕尼黑的**全球管理**。

Chandler 是一名全球服务经理，负责协调全球所有服务运营。Joey 和 Ross 分别是 EMEA 和美洲的服务主管，他们向他汇报工作。

钱德勒希望通过KNOWRON提供两种类型的文档：
...
以下是**产品访问组**可以提供帮助的地方：在KNOWRON的帮助下，Chandler创建了三个不同的访问组：
