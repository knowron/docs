# Product Update v1.18.0: Insights dashboard


The update includes [A new insights dashboard to understand how your knowledge base is doing and how to make it work better](#insights-dashboard-makes-it-easier-to-close-knowledge-gaps)
