...
If you haven't already, download our editable template. The template is also [available here](https://knowron-website.s3.eu-central-1.amazonaws.com/KnowronMachineUploadTemplate.xlsx).
...
QR codes are created automatically once you create your machines. After creating the machines, simply click on the "View" button on the machine inventory and see the QR code.
