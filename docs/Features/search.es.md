...
Si desea que el sistema admita un idioma que no sea nuestras opciones predeterminadas ('Inglés', 'Alemán', 'Español', 'Chino'), comuníquese con nuestro [team](mailto:sales@knowron.com de ventas].
